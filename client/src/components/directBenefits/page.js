  ...
  return (
    <div className="bg-[#e2e8f0] text-gray-800 py-16">
      <div className="container mx-auto text-center">
        <h3 className="text-sm uppercase tracking-widest text-gray-600 mb-2">KIBU Home & Apartments</h3>
        <h1 className="text-4xl font-bold mb-4">The Best Offers Are Right Here</h1>
        <p className="text-lg mb-12 text-gray-600">Enjoy these extras at no additional cost when you book directly through our website. Book direct and save!</p>
