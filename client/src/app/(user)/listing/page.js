...
import { Button, ButtonGroup, Link as NextUILink, Image } from "@nextui-org/react"
    ...
    <div>
        ...
        <div className='ml-4'>
          <ButtonGroup>
            <Button className='border-r border-black hover:bg-blue-400 font-semibold'>
              <NextUILink href={'../listing'} className='text-black'> Nayabazar </NextUILink>
            </Button>
            <Button className='hover:bg-blue-400 font-semibold'>
              <NextUILink href={'../listing/bookRoomsBoudha'} className='text-black'> Boudha </NextUILink>
            </Button>
          </ButtonGroup>
        </div>
      </div>
      <div>
        <Grid templateColumns='repeat(3, 1fr)' className="ml-4" gap={1}>
          {listingList.filter(item => item.listingLocation === 'Nayabazar').map((item) => (
